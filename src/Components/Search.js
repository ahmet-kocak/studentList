...
function Search(props) {
  ...
  const onClickButton = (e) => {
        ...
        if (filtered.length>0) {const boolenData = checkValidity(inputData.joiningDate,filtered[0].validityDate);
              if (boolenData) {props.listFunction(inputData.studentName.toLowerCase())
